...
#filename = 'mp4/MSU_.mp4'
filename = r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/lane_navigation/data/images/video01.avi'

file_size = (1920,1080) # Assumes 1920x1080 mp4
scale_ratio = 1 # Option to scale to fraction of original size. 

# We want to save the output to a video file
output_filename = r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/lane_navigation/data/images/video_drive.avi'
...
class Lane(object):
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (int(440),int(645)), # Top-left corner
      (int(45),int(850)), # Bottom-left corner			
      (int(877),int(860)), # Bottom-right corner
      (int(716),int(645)) # Top-right corner
    ])
    '''
    '''
    #Baltimore MSU 
    self.roi_points = np.float32([
      (int(.46*width),int(0.60*height)), # Top-left corner
      (int(0.350*width), int(.715*height-1)), # Bottom-left corner			
      (int(0.6220*width),int(.755*height-1)), # Bottom-right corner
      (int(0.536*width),int(0.60*height)) # Top-right corner
    ])
    '''

    #project_video/ Threshold 80
     
    self.roi_points = np.float32([
      (int(0.456*width),int(0.690*height)), # Top-left corner
      (0, height-1), # Bottom-left corner			
      (int(0.958*width),height-1), # Bottom-right corner
      (int(0.6183*width),int(0.690*height)) # Top-right corner
    ])
...
##########################################################################
    ...
    self.roi_points = np.float32([
      (int(0),int(50)), # Top-left corner
      (int(45),int(50)), # Bottom-left corner			
      (int(50),int(50)), # Bottom-right corner
      (int(70),int(50)) # Top-right corner
    ])
    '''
##############################################################################
  ...
  def get_line_markings(self, frame=None):
    ...
    _, s_binary = edge.threshold(s_channel, (145, 255))
