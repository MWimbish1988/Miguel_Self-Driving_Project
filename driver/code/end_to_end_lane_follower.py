...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                car=None,
                model_path= r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/lane_navigation/data/model_result/lane_navigation.h5'):
    ...
    def follow_lane(self, frame):
        # Main entry point of the lane er
...
def test_video(video_file):
    ...
    try:
        ...
        while cap.isOpened():
            ...
            #combo_image3 = Lane_detection.follow_lane(frame_copy)
