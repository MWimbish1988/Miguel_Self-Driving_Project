...
def main():
    path = r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/object_detection'
    os.chdir(path)
    ...
    args.model = r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/object_detection/data/model_result/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite'
    args.label = r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/models/object_detection/data/model_result/coco_labels.txt'
...
#############################################################################################################################
                ...
                #    cv2.putText(image, 'Vehicle', (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,0,255),2)
            
                    # Display frames in a window
                    #cv2.imshow('Car Detection', img)

                img = img.copy()
                scale_ratio = 2 # Option to scale to fraction of original size. 
...
###############################################################################################################################
                ...
                output_filename =  r'C:/Users/m_wim/OneDrive/Desktop/DeepPiCar/orig_lane_detection_1_lanes.mp4'                 ##
                results = cv2.VideoWriter(img_pil, threshold=min_confidence, keep_aspect_ratio=True,
                                   relative_coord=False, top_k=5)                                                             ##
                                                                                                                                ##
                #results = cv2.VideoWriter(output_filename,                                                                      ##
                #            fourcc,                                                                                             ##
